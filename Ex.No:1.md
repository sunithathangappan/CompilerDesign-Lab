...
int main() {
    ...
    scanf(" %c", &srch);  // space before %c to skip newline
...
## OUTPUT:
<img width="895" height="493" alt="image" src="https://github.com/user-attachments/assets/e254f4b9-34e3-4e28-925c-453ff97614e4" />
